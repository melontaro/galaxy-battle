...
//            app.RegisterCLRMethodRedirection(method, GetOptionalCustomModifiers_23);
            ...
            app.RegisterCLRMethodRedirection(method, Equals_26);
            args = new Type[]{};
            ...
            app.RegisterCLRMethodRedirection(method, get_IsSecurityCritical_30);
            args = new Type[]{};
            method = type.GetMethod("get_IsSecuritySafeCritical", flag, null, args, null);
            app.RegisterCLRMethodRedirection(method, get_IsSecuritySafeCritical_31);
            args = new Type[]{};
            method = type.GetMethod("get_IsSecurityTransparent", flag, null, args, null);
            app.RegisterCLRMethodRedirection(method, get_IsSecurityTransparent_32);
...
//        }
        ...
        static StackObject* get_IsSecurityCritical_30(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ILRuntime.Runtime.Enviorment.AppDomain __domain = __intp.AppDomain;
            StackObject* ptr_of_this_method;
            StackObject* __ret = ILIntepreter.Minus(__esp, 1);
        ...
        static StackObject* get_IsSecuritySafeCritical_31(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ILRuntime.Runtime.Enviorment.AppDomain __domain = __intp.AppDomain;
            StackObject* ptr_of_this_method;
            StackObject* __ret = ILIntepreter.Minus(__esp, 1);
        ...
        static StackObject* get_IsSecurityTransparent_32(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ILRuntime.Runtime.Enviorment.AppDomain __domain = __intp.AppDomain;
            StackObject* ptr_of_this_method;
            StackObject* __ret = ILIntepreter.Minus(__esp, 1);
