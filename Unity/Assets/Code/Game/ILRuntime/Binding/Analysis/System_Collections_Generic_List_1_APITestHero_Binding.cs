...
{
    unsafe class System_Collections_Generic_List_1_APITestHero_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            MethodBase method;
            Type[] args;
            Type type = typeof(System.Collections.Generic.List<Code.BDFramework.UnitTest.Test.APITestHero>);
            args = new Type[]{typeof(Code.BDFramework.UnitTest.Test.APITestHero)};
        ...
        static StackObject* Ctor_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            var result_of_this_method = new System.Collections.Generic.List<Code.BDFramework.UnitTest.Test.APITestHero>();
