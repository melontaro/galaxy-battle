...
{
    unsafe class Mono_Cecil_MemberReference_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            MethodBase method;
            Type[] args;
            Type type = typeof(Mono.Cecil.MemberReference);
            args = new Type[]{};
        ...
        static StackObject* get_FullName_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            Mono.Cecil.MemberReference instance_of_this_method = (Mono.Cecil.MemberReference)typeof(Mono.Cecil.MemberReference).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack));
