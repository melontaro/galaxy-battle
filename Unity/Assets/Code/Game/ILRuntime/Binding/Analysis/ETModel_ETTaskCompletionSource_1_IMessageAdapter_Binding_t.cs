...
{
    unsafe class ETModel_ETTaskCompletionSource_1_IMessageAdapter_Binding_Adaptor_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            MethodBase method;
            Type[] args;
            Type type = typeof(ETModel.ETTaskCompletionSource<global::IMessageAdapter.Adaptor>);
            args = new Type[]{};
        ...
        static StackObject* get_Task_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            ETModel.ETTaskCompletionSource<global::IMessageAdapter.Adaptor> instance_of_this_method = (ETModel.ETTaskCompletionSource<global::IMessageAdapter.Adaptor>)typeof(ETModel.ETTaskCompletionSource<global::IMessageAdapter.Adaptor>).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack));
        ...
        static StackObject* SetResult_1(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            ptr_of_this_method = ILIntepreter.Minus(__esp, 1);
            global::IMessageAdapter.Adaptor @result = (global::IMessageAdapter.Adaptor)typeof(global::IMessageAdapter.Adaptor).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack));
            __intp.Free(ptr_of_this_method);
        ...
        static StackObject* Ctor_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            var result_of_this_method = new ETModel.ETTaskCompletionSource<global::IMessageAdapter.Adaptor>();
